...
<body>
	...
	<!-- Main navbar -->
	<?php $this->load->view('template/navbar_v') ?>
	<!-- /main navbar -->
				...
				<div class="card card-sidebar-mobile">
					...
					<div class="sidebar-user">
						<div class="card-body">
							<div class="media">
								<div class="mr-3">
									<a href="#"><img src="<?= base_url() ?>public/images/profile/king-salmanan.png" width="38" height="38" class="rounded-circle" alt=""></a>
								</div>
					...
					<div class="card-body p-0">
						<ul class="nav nav-sidebar" data-nav-type="accordion">
							<!-- navbar -->
							<?php $this->load->view('template/sidebar_v') ?>
							<!-- navbar -->
						</ul>
					</div>
					<!-- /main navigation -->
