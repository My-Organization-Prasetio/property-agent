    ...
    <li class="nav-item"><a href="<?= base_url() ?>asset-management" class="nav-link disabled"><i class="icon-office"></i>Manajemen Aset <span class="badge bg-transparent align-self-center ml-auto">Segera Hadir</span></a></li>  
