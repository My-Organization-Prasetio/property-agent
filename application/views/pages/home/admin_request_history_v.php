            ...
            <table class="table table-lg invoice-archive">
                ...
                <tbody>
                        ...
                        <td class="text-center">
                            <div class="list-icons list-icons-extended">
                                <div class="list-icons-item dropdown">
                                    <a href="<?= base_url() ?>admin/request-detail/REQ2110BK001" class="list-icons-item"><i class="icon-file-eye"></i></a>
                                </div>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge badge-danger">Canceled On 16, 2015</span>
                        </td>
                        <td>
                            <span class="d-block font-size-sm text-muted">Animal Protein (33 KG)</span>
                        </td>
