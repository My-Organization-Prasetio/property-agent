            ...
            <form action="#" class="form-horizontal" name="add-material" id="add-material">
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="Vendor/Supplier" class="form-control" name="product_name">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="PIC" class="form-control" name="product_name">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="E-Mail Address" class="form-control" name="product_name">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="Price" class="form-control" name="product_price">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" placeholder="" name="product_margin_price" class="form-control">
                        </div>
                    </div>
