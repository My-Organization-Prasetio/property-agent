            ...
            <div class="card-header bg-transparent header-elements-inline">
                ...
                <div class="header-elements">
                    <div class="list-icons">
                        ...
                        <a class="list-icons-item" data-action="Rejected"></a>
                    </div>
                </div>
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="status" class="form-control form-control-select2" data-placeholder="Select status">
                                <option value="overdue">Approve</option>
                        ...
                        <td>
                            <span class="badge badge-success">Need Supply Material</span>
                        </td>
                        <td>
                            <span class="d-block font-size-sm text-muted">Animal Protein (33 KG)</span>
                        </td>
                            ...
                            <div class="list-icons list-icons-extended">
                                <div class="list-icons-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a href="#" class="dropdown-item"><i class="icon-file-plus"></i> Revision</a>
                                        <a href="#" class="dropdown-item"><i class="icon-cross2"></i> Rejected</a>
                                    </div>
                                </div>
                            </div>
                        </td>
